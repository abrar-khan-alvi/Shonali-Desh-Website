...
const JoinUs: React.FC = () => {
  ...
  const [hoveredCard, setHoveredCard] = useState<'expert' | null>(null);
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-400 text-xl max-w-2xl mx-auto font-light">
            ...
            <br className="hidden md:block" /> Apply to become an expert today.
          </p>
        </div>

        {/* Cards Container */}
        <div className="flex justify-center max-w-6xl mx-auto md:h-[500px]">

          {/* Expert Card */}
          <div
            ref={expertCardRef}
            className={`perspective-card relative w-full max-w-2xl h-[500px] md:h-full rounded-3xl cursor-pointer group transition-all duration-500 opacity-100 scale-100`}
